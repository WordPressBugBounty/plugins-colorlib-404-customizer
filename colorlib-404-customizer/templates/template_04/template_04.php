...
<div id="colorlib-notfound">
    <div class="colorlib-notfound">
        <div class="colorlib-notfound-404">
            <h1 id="colorlib_404_customizer_page_heading"><?php echo wp_kses_post( cnfp_get_option( 'colorlib_404_customizer_page_heading' ) ); ?></h1>
            <h2 id="colorlib_404_customizer_content"><?php echo wp_kses_post( cnfp_get_option( 'colorlib_404_customizer_content' ) ); ?></h2>
        </div>
